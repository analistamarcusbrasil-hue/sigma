...
assert.equal(migrations.length, 30, "A cadeia homologada deve conter 30 migrations");
assert.deepEqual(
  migrations.map((nome) => nome.slice(0, 8)),
  [...Array.from({ length: 22 }, (_, indice) => String(20260710 + indice)), "20260801", "20260802", "20260803", "20260804", "20260805", "20260806", "20260807", "20260808"],
