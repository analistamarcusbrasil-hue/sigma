...
assert.equal(migrations.length, 19, "A cadeia homologada deve conter 19 migrations");
assert.deepEqual(migrations.map((nome) => nome.slice(0, 8)), Array.from({ length: 19 }, (_, indice) => String(20260710 + indice)), "Migrations fora de ordem");
