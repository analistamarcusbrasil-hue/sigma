    ...
    <div className="mt-8 space-y-6">
      ...
      <section id="visao-financeira" className="scroll-mt-6 grid gap-4 md:grid-cols-2 treasury-summary-grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
        ...
        <article className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
          ...
          <h3 className="mt-3 font-bold text-red-300 text-2xl max-w-full whitespace-nowrap tabular-nums tracking-tight leading-none">
        ...
        <article className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
          ...
          <h3 className="mt-3 font-bold text-emerald-300 text-2xl max-w-full whitespace-nowrap tabular-nums tracking-tight leading-none">
            ...
            <tbody>
              {regrasOrdenadas.map((regra) => (
                <tr key={regra.id} className="border-t border-white/10">
                  ...
                  <td className="px-5 py-4 font-bold text-amber-300 text-2xl max-w-full whitespace-nowrap tabular-nums tracking-tight leading-none">
                  ...
                  <tr key={obreiro.id} className="border-t border-white/10 hover:bg-white/[0.03]">
                    ...
                    <td className="px-5 py-4">
                      <div className="w-fit rounded-2xl border border-emerald-400/20 bg-emerald-400/10 px-4 py-2">
                        <p className="font-bold text-emerald-300 text-2xl max-w-full whitespace-nowrap tabular-nums tracking-tight leading-none">
                    ...
                    <td className="px-5 py-4">
                      <div className="w-fit rounded-2xl border border-red-400/20 bg-red-400/10 px-4 py-2">
                        <p className="font-bold text-red-300 text-2xl max-w-full whitespace-nowrap tabular-nums tracking-tight leading-none">
                    ...
                    <td className="px-5 py-4">
                      <div className="w-fit rounded-2xl border border-amber-400/20 bg-amber-400/10 px-4 py-2">
                        <p className="font-bold text-amber-300 text-2xl max-w-full whitespace-nowrap tabular-nums tracking-tight leading-none">
                          {formatarMoeda(valorVigenteDoMes(mesSelecionado))}
                        </p>
      ...
      <section id="custos" className="scroll-mt-6 rounded-3xl border border-white/10 bg-white/[0.04] p-6">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-4">
          ...
          <article className="rounded-2xl border border-emerald-400/20 bg-emerald-400/10 p-4">
            ...
            <h4 className="mt-2 text-2xl font-bold text-emerald-300 max-w-full whitespace-nowrap tabular-nums tracking-tight leading-none">
              {formatarMoeda(resumoCustos.totalPago)}
            </h4>
          </article>
          ...
          <article className="rounded-2xl border border-amber-400/20 bg-amber-400/10 p-4">
            ...
            <h4 className="mt-2 text-2xl font-bold text-amber-300 max-w-full whitespace-nowrap tabular-nums tracking-tight leading-none">
              {formatarMoeda(resumoCustos.totalEmAberto)}
            </h4>
          </article>
          ...
          <article className="rounded-2xl border border-red-400/20 bg-red-400/10 p-4">
            ...
            <h4 className="mt-2 text-2xl font-bold text-red-300 max-w-full whitespace-nowrap tabular-nums tracking-tight leading-none">
