...
export default async function UsuariosPage() {
  ...
  return <AppShell secao="Administração" titulo="Usuários e Acessos" subtitulo="Convide usuários, vincule-os a obreiros e mantenha permissões centralizadas." acao={<Link href="/usuarios/desbloqueios" className="rounded-xl border border-amber-400/30 px-4 py-3 text-amber-200">Desbloqueios administrativos</Link>}><UsuariosClient usuarios={(data ?? []) as PerfilSigma[]} /></AppShell>;
}
